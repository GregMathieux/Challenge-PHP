<?php
session_start();
include_once("page/connexionExo.php");
?>
<!DOCTYPE html>
<html lang="fr">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <?php if($_SESSION['login']=="yes"){echo "<a href='page/admin.php'>Administration</a>";} ?>
                    </li>
                    <?php echo "<button type='button' class='btn btn-default navbar-btn' id='btnlog' onclick=window.location.href='page/admincheck.php'>Log In</button>";?>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        </div>
